...
const ROWS = [
  [
    { title: "Web Technologies", items: ["HTML", "CSS", "JavaScript", "React", "MERN Stack"] },
    { title: "Programming Languages", items: ["Python", "C++", "Java"] },
    { title: "Databases & Tools", items: ["MySQL", "MongoDB", "Git"] },
    { title: "Frameworks & Libraries", items: ["Express", "REST API"] },
  ],
  [
    {
      title: "Core Concepts",
    ...
    {
      title: "Soft Skills",
      items: ["Problem Solving", "Creativity", "Adaptability", "Communication"],
    },
  ],
];
